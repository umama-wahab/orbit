      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-between p-12 relative overflow-hidden">
        ...
        >
          <div
            ...
            style={{ background: "linear-gradient(135deg, var(--rose), var(--purple))" }}
          >
        ...
        >
          ...
          <p className="text-base leading-relaxed" style={{ color: "var(--text-secondary)" }}>
            Join thousands chatting in real time — openly with friends, or anonymously in circles.
          </p>
        </motion.div>
        ...
        >
          {[
            ...
            <div key={f.label} className="flex items-center gap-2 px-3.5 py-2 rounded-full glass-panel">
